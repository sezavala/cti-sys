...
class TestGSheetGroup:
    ...
    @pytest.mark.gsheet
    def testGroupAttendance(self, monkeypatch, client, mock_gspread):
        ...
        # Use the same mocked client the app used
    ...
    @pytest.mark.integration
    @pytest.mark.gsheet
    def testDefaultLookbackDays(self, monkeypatch, client, mock_gspread):
        monkeypatch.setenv("ROSTER_SHEET_KEY", environ.get("TEST_SHEET_KEY"))
